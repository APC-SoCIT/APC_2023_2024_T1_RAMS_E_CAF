...
<section class="vh-100" style="background-image: url('images/loginbg.png'); border-radius: 25px;">
    <div class="container py-5 h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-12 col-md-8 col-lg-6 col-xl-5" style="border-radius: 25px; background-color:rgba(0,0,0,0.00);">
                <div class="card shadow-2-strong" style="border-radius: 25px; background-color:rgba(0,0,0,0.00);">
                    <div style="background-color:rgba(5,0,238, .7); border-radius: 25px;">
                        <div class="card-body p-5 text-center">
                        <h3><img src="images/ramslogo.png" alt="" height=200px; width=100px;></h3>
        
                    <h3 class="mb-5" style="color:white;">Sign in with Office 365</h3>
                    ...
                    <a href="#policy" data-bs-toggle="modal" data-bs-target="#policy" class="btn btn-primary btn-lg btn-block" id="loginbutton" style="background-color:rgba(222,172,72,1);">Login</a>
                </div>
